...
open class Module(
        ...
        @SerializedName("modname")  var modName: String = "",
    ...
    enum class Type {
        RESOURCCE, FORUM, LABEL, ASSIGNMENT, FOLDER, QUIZ, URL, PAGE, DEFAULT, BOOK
    }
    ...
    val moduleIcon: Int
        get() {
            return when (modType) {
                Type.RESOURCCE -> if (contents.isNotEmpty()) {
