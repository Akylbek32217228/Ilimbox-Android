...
public class ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy extends ilimboxAndroid.bphc.ilimbox.models.course.Content
    implements RealmObjectProxy, ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface {
    ...
    private ProxyState<ilimboxAndroid.bphc.ilimbox.models.course.Content> proxyState;

    ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<ilimboxAndroid.bphc.ilimbox.models.course.Content>(this);
    ...
    @SuppressWarnings("cast")
    public static ilimboxAndroid.bphc.ilimbox.models.course.Content createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        ilimboxAndroid.bphc.ilimbox.models.course.Content obj = realm.createObjectInternal(ilimboxAndroid.bphc.ilimbox.models.course.Content.class, true, excludeFields);

        final ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface objProxy = (ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface) obj;
    ...
    public static ilimboxAndroid.bphc.ilimbox.models.course.Content createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final ilimboxAndroid.bphc.ilimbox.models.course.Content obj = new ilimboxAndroid.bphc.ilimbox.models.course.Content();
        final ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface objProxy = (ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.course.Content.class), false, Collections.<String>emptyList());
        io.realm.ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy obj = new io.realm.ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static ilimboxAndroid.bphc.ilimbox.models.course.Content copyOrUpdate(Realm realm, ContentColumnInfo columnInfo, ilimboxAndroid.bphc.ilimbox.models.course.Content object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (ilimboxAndroid.bphc.ilimbox.models.course.Content) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static ilimboxAndroid.bphc.ilimbox.models.course.Content copy(Realm realm, ContentColumnInfo columnInfo, ilimboxAndroid.bphc.ilimbox.models.course.Content newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (ilimboxAndroid.bphc.ilimbox.models.course.Content) cachedRealmObject;
        }

        ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface realmObjectSource = (ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface) newObject;

        Table table = realm.getTable(ilimboxAndroid.bphc.ilimbox.models.course.Content.class);
        ...
        io.realm.ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, ilimboxAndroid.bphc.ilimbox.models.course.Content object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(ilimboxAndroid.bphc.ilimbox.models.course.Content.class);
        long tableNativePtr = table.getNativePtr();
        ContentColumnInfo columnInfo = (ContentColumnInfo) realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.course.Content.class);
        long colKey = OsObject.createRow(table);
        cache.put(object, colKey);
        String realmGet$fileName = ((ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface) object).realmGet$fileName();
        if (realmGet$fileName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fileNameColKey, colKey, realmGet$fileName, false);
        }
        String realmGet$fileUrl = ((ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface) object).realmGet$fileUrl();
        if (realmGet$fileUrl != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fileUrlColKey, colKey, realmGet$fileUrl, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.fileSizeColKey, colKey, ((ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface) object).realmGet$fileSize(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.timeCreatedColKey, colKey, ((ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface) object).realmGet$timeCreated(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.timeModifiedColKey, colKey, ((ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface) object).realmGet$timeModified(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.moduleIdColKey, colKey, ((ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface) object).realmGet$moduleId(), false);
        return colKey;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ContentColumnInfo columnInfo = (ContentColumnInfo) realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.course.Content.class);
        ilimboxAndroid.bphc.ilimbox.models.course.Content object = null;
        while (objects.hasNext()) {
            object = (ilimboxAndroid.bphc.ilimbox.models.course.Content) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, ilimboxAndroid.bphc.ilimbox.models.course.Content object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(ilimboxAndroid.bphc.ilimbox.models.course.Content.class);
    ...
    public static ilimboxAndroid.bphc.ilimbox.models.course.Content createDetachedCopy(ilimboxAndroid.bphc.ilimbox.models.course.Content realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        ilimboxAndroid.bphc.ilimbox.models.course.Content unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new ilimboxAndroid.bphc.ilimbox.models.course.Content();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (ilimboxAndroid.bphc.ilimbox.models.course.Content) cachedObject.object;
            }
            unmanagedObject = (ilimboxAndroid.bphc.ilimbox.models.course.Content) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface unmanagedCopy = (ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface) unmanagedObject;
        ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface realmSource = (ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxyInterface) realmObject;
