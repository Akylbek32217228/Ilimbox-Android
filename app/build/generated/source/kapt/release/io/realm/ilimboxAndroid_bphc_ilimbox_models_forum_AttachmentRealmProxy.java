...
public class ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy extends ilimboxAndroid.bphc.ilimbox.models.forum.Attachment
    implements RealmObjectProxy, ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface {
    ...
    private ProxyState<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment> proxyState;

    ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment>(this);
    ...
    @SuppressWarnings("cast")
    public static ilimboxAndroid.bphc.ilimbox.models.forum.Attachment createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        ilimboxAndroid.bphc.ilimbox.models.forum.Attachment obj = realm.createObjectInternal(ilimboxAndroid.bphc.ilimbox.models.forum.Attachment.class, true, excludeFields);

        final ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface objProxy = (ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface) obj;
    ...
    public static ilimboxAndroid.bphc.ilimbox.models.forum.Attachment createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final ilimboxAndroid.bphc.ilimbox.models.forum.Attachment obj = new ilimboxAndroid.bphc.ilimbox.models.forum.Attachment();
        final ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface objProxy = (ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.forum.Attachment.class), false, Collections.<String>emptyList());
        io.realm.ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy obj = new io.realm.ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static ilimboxAndroid.bphc.ilimbox.models.forum.Attachment copyOrUpdate(Realm realm, AttachmentColumnInfo columnInfo, ilimboxAndroid.bphc.ilimbox.models.forum.Attachment object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (ilimboxAndroid.bphc.ilimbox.models.forum.Attachment) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static ilimboxAndroid.bphc.ilimbox.models.forum.Attachment copy(Realm realm, AttachmentColumnInfo columnInfo, ilimboxAndroid.bphc.ilimbox.models.forum.Attachment newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (ilimboxAndroid.bphc.ilimbox.models.forum.Attachment) cachedRealmObject;
        }

        ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface realmObjectSource = (ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface) newObject;

        Table table = realm.getTable(ilimboxAndroid.bphc.ilimbox.models.forum.Attachment.class);
        ...
        io.realm.ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, ilimboxAndroid.bphc.ilimbox.models.forum.Attachment object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(ilimboxAndroid.bphc.ilimbox.models.forum.Attachment.class);
        long tableNativePtr = table.getNativePtr();
        AttachmentColumnInfo columnInfo = (AttachmentColumnInfo) realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.forum.Attachment.class);
        long colKey = OsObject.createRow(table);
        cache.put(object, colKey);
        String realmGet$fileName = ((ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface) object).realmGet$fileName();
        if (realmGet$fileName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fileNameColKey, colKey, realmGet$fileName, false);
        }
        String realmGet$mimeType = ((ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface) object).realmGet$mimeType();
        if (realmGet$mimeType != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.mimeTypeColKey, colKey, realmGet$mimeType, false);
        }
        String realmGet$fileUrl = ((ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface) object).realmGet$fileUrl();
        if (realmGet$fileUrl != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fileUrlColKey, colKey, realmGet$fileUrl, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.fileSizeColKey, colKey, ((ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface) object).realmGet$fileSize(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.timeModifiedColKey, colKey, ((ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface) object).realmGet$timeModified(), false);
        return colKey;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        AttachmentColumnInfo columnInfo = (AttachmentColumnInfo) realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.forum.Attachment.class);
        ilimboxAndroid.bphc.ilimbox.models.forum.Attachment object = null;
        while (objects.hasNext()) {
            object = (ilimboxAndroid.bphc.ilimbox.models.forum.Attachment) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, ilimboxAndroid.bphc.ilimbox.models.forum.Attachment object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(ilimboxAndroid.bphc.ilimbox.models.forum.Attachment.class);
    ...
    public static ilimboxAndroid.bphc.ilimbox.models.forum.Attachment createDetachedCopy(ilimboxAndroid.bphc.ilimbox.models.forum.Attachment realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        ilimboxAndroid.bphc.ilimbox.models.forum.Attachment unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new ilimboxAndroid.bphc.ilimbox.models.forum.Attachment();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (ilimboxAndroid.bphc.ilimbox.models.forum.Attachment) cachedObject.object;
            }
            unmanagedObject = (ilimboxAndroid.bphc.ilimbox.models.forum.Attachment) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface unmanagedCopy = (ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface) unmanagedObject;
        ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface realmSource = (ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy aAttachment = (ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy)o;
