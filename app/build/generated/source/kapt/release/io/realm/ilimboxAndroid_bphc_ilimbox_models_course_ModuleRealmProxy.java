...
public class ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxy extends ilimboxAndroid.bphc.ilimbox.models.course.Module
    implements RealmObjectProxy, ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface {
    ...
    private ProxyState<ilimboxAndroid.bphc.ilimbox.models.course.Module> proxyState;
    private RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content> contentsRealmList;

    ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<ilimboxAndroid.bphc.ilimbox.models.course.Module>(this);
    ...
    @Override
    public RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content> realmGet$contents() {
        proxyState.getRealm$realm().checkIfValid();
        ...
        if (contentsRealmList != null) {
            ...
            contentsRealmList = new RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content>(ilimboxAndroid.bphc.ilimbox.models.course.Content.class, osList, proxyState.getRealm$realm());
            return contentsRealmList;
        }
    }

    @Override
    public void realmSet$contents(RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content> value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content> original = value;
                value = new RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content>();
                for (ilimboxAndroid.bphc.ilimbox.models.course.Content item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ilimboxAndroid.bphc.ilimbox.models.course.Content linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static ilimboxAndroid.bphc.ilimbox.models.course.Module createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        ilimboxAndroid.bphc.ilimbox.models.course.Module obj = null;
        if (update) {
            Table table = realm.getTable(ilimboxAndroid.bphc.ilimbox.models.course.Module.class);
            ModuleColumnInfo columnInfo = (ModuleColumnInfo) realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.course.Module.class);
            ...
            if (colKey != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(colKey), realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.course.Module.class), false, Collections.<String> emptyList());
                    obj = new io.realm.ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxy) realm.createObjectInternal(ilimboxAndroid.bphc.ilimbox.models.course.Module.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxy) realm.createObjectInternal(ilimboxAndroid.bphc.ilimbox.models.course.Module.class, json.getInt("id"), true, excludeFields);
                }
            } else {
        ...
        final ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface objProxy = (ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) obj;
        ...
        if (json.has("contents")) {
            if (json.isNull("contents")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ilimboxAndroid.bphc.ilimbox.models.course.Content item = ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static ilimboxAndroid.bphc.ilimbox.models.course.Module createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final ilimboxAndroid.bphc.ilimbox.models.course.Module obj = new ilimboxAndroid.bphc.ilimbox.models.course.Module();
        final ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface objProxy = (ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$contents(new RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        ilimboxAndroid.bphc.ilimbox.models.course.Content item = ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$contents().add(item);
                    }
                    reader.endArray();
                }
    ...
    private static ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.course.Module.class), false, Collections.<String>emptyList());
        io.realm.ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxy obj = new io.realm.ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static ilimboxAndroid.bphc.ilimbox.models.course.Module copyOrUpdate(Realm realm, ModuleColumnInfo columnInfo, ilimboxAndroid.bphc.ilimbox.models.course.Module object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (ilimboxAndroid.bphc.ilimbox.models.course.Module) cachedRealmObject;
        }

        ilimboxAndroid.bphc.ilimbox.models.course.Module realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(ilimboxAndroid.bphc.ilimbox.models.course.Module.class);
            long pkColumnKey = columnInfo.idColKey;
            long colKey = table.findFirstLong(pkColumnKey, ((ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) object).realmGet$id());
            if (colKey == Table.NO_MATCH) {
                canUpdate = false;
            } else {
                try {
                    objectContext.set(realm, table.getUncheckedRow(colKey), columnInfo, false, Collections.<String> emptyList());
                    realmObject = new io.realm.ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxy();
    ...
    public static ilimboxAndroid.bphc.ilimbox.models.course.Module copy(Realm realm, ModuleColumnInfo columnInfo, ilimboxAndroid.bphc.ilimbox.models.course.Module newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (ilimboxAndroid.bphc.ilimbox.models.course.Module) cachedRealmObject;
        }

        ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface realmObjectSource = (ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) newObject;
        ...
        io.realm.ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        // Finally add all fields that reference other Realm Objects, either directly or through a list
        RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content> contentsList = realmObjectSource.realmGet$contents();
        if (contentsList != null) {
            RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content> contentsRealmList = realmObjectCopy.realmGet$contents();
            contentsRealmList.clear();
            for (int i = 0; i < contentsList.size(); i++) {
                ilimboxAndroid.bphc.ilimbox.models.course.Content contentsItem = contentsList.get(i);
                ilimboxAndroid.bphc.ilimbox.models.course.Content cachecontents = (ilimboxAndroid.bphc.ilimbox.models.course.Content) cache.get(contentsItem);
                if (cachecontents != null) {
                    contentsRealmList.add(cachecontents);
                } else {
                    contentsRealmList.add(ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy.copyOrUpdate(realm, (ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy.ContentColumnInfo) realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.course.Content.class), contentsItem, update, cache, flags));
                }
            }
        }
    ...
    public static long insert(Realm realm, ilimboxAndroid.bphc.ilimbox.models.course.Module object, Map<RealmModel,Long> cache) {
        ...
        long pkColumnKey = columnInfo.idColKey;
        long colKey = Table.NO_MATCH;
        Object primaryKeyValue = ((ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) object).realmGet$id();
        if (primaryKeyValue != null) {
            colKey = Table.nativeFindFirstInt(tableNativePtr, pkColumnKey, ((ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) object).realmGet$id());
        }
        if (colKey == Table.NO_MATCH) {
            colKey = OsObject.createRowWithPrimaryKey(table, pkColumnKey, ((ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) object).realmGet$id());
        } else {
            Table.throwDuplicatePrimaryKeyException(primaryKeyValue);
        }
        cache.put(object, colKey);
        Table.nativeSetLong(tableNativePtr, columnInfo.instanceColKey, colKey, ((ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) object).realmGet$instance(), false);
        String realmGet$url = ((ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) object).realmGet$url();
        if (realmGet$url != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.urlColKey, colKey, realmGet$url, false);
        }
        String realmGet$modIcon = ((ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) object).realmGet$modIcon();
        if (realmGet$modIcon != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.modIconColKey, colKey, realmGet$modIcon, false);
        }
        String realmGet$modName = ((ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) object).realmGet$modName();
        if (realmGet$modName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.modNameColKey, colKey, realmGet$modName, false);
        }
        String realmGet$description = ((ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) object).realmGet$description();
        if (realmGet$description != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.descriptionColKey, colKey, realmGet$description, false);
        }

        RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content> contentsList = ((ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) object).realmGet$contents();
        if (contentsList != null) {
            OsList contentsOsList = new OsList(table.getUncheckedRow(colKey), columnInfo.contentsColKey);
            for (ilimboxAndroid.bphc.ilimbox.models.course.Content contentsItem : contentsList) {
                Long cacheItemIndexcontents = cache.get(contentsItem);
                if (cacheItemIndexcontents == null) {
                    cacheItemIndexcontents = ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy.insert(realm, contentsItem, cache);
                }
                contentsOsList.addRow(cacheItemIndexcontents);
            }
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.courseSectionIdColKey, colKey, ((ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) object).realmGet$courseSectionId(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isUnreadColKey, colKey, ((ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) object).realmGet$isUnread(), false);
        String realmGet$name = ((ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) object).realmGet$name();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        ModuleColumnInfo columnInfo = (ModuleColumnInfo) realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.course.Module.class);
        long pkColumnKey = columnInfo.idColKey;
        ilimboxAndroid.bphc.ilimbox.models.course.Module object = null;
        while (objects.hasNext()) {
            object = (ilimboxAndroid.bphc.ilimbox.models.course.Module) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, ilimboxAndroid.bphc.ilimbox.models.course.Module object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(ilimboxAndroid.bphc.ilimbox.models.course.Module.class);
        ...
        if (contentsList != null && contentsList.size() == contentsOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexcontents = cache.get(contentsItem);
                if (cacheItemIndexcontents == null) {
                    cacheItemIndexcontents = ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy.insertOrUpdate(realm, contentsItem, cache);
                }
    ...
    public static ilimboxAndroid.bphc.ilimbox.models.course.Module createDetachedCopy(ilimboxAndroid.bphc.ilimbox.models.course.Module realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        ilimboxAndroid.bphc.ilimbox.models.course.Module unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new ilimboxAndroid.bphc.ilimbox.models.course.Module();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (ilimboxAndroid.bphc.ilimbox.models.course.Module) cachedObject.object;
            }
            unmanagedObject = (ilimboxAndroid.bphc.ilimbox.models.course.Module) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface unmanagedCopy = (ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) unmanagedObject;
        ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface realmSource = (ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) realmObject;
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content> managedcontentsList = realmSource.realmGet$contents();
            RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content> unmanagedcontentsList = new RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content>();
            unmanagedCopy.realmSet$contents(unmanagedcontentsList);
            int nextDepth = currentDepth + 1;
            int size = managedcontentsList.size();
            for (int i = 0; i < size; i++) {
                ilimboxAndroid.bphc.ilimbox.models.course.Content item = ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy.createDetachedCopy(managedcontentsList.get(i), nextDepth, maxDepth, cache);
    ...
    static ilimboxAndroid.bphc.ilimbox.models.course.Module update(Realm realm, ModuleColumnInfo columnInfo, ilimboxAndroid.bphc.ilimbox.models.course.Module realmObject, ilimboxAndroid.bphc.ilimbox.models.course.Module newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface realmObjectTarget = (ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) realmObject;
        ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface realmObjectSource = (ilimboxAndroid_bphc_ilimbox_models_course_ModuleRealmProxyInterface) newObject;
        Table table = realm.getTable(ilimboxAndroid.bphc.ilimbox.models.course.Module.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, flags);
        builder.addInteger(columnInfo.idColKey, realmObjectSource.realmGet$id());
        ...
        RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content> contentsList = realmObjectSource.realmGet$contents();
        if (contentsList != null) {
            RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content> contentsManagedCopy = new RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content>();
            for (int i = 0; i < contentsList.size(); i++) {
                ilimboxAndroid.bphc.ilimbox.models.course.Content contentsItem = contentsList.get(i);
                ilimboxAndroid.bphc.ilimbox.models.course.Content cachecontents = (ilimboxAndroid.bphc.ilimbox.models.course.Content) cache.get(contentsItem);
                if (cachecontents != null) {
                    ...
                    contentsManagedCopy.add(ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy.copyOrUpdate(realm, (ilimboxAndroid_bphc_ilimbox_models_course_ContentRealmProxy.ContentColumnInfo) realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.course.Content.class), contentsItem, true, cache, flags));
                }
            }
            builder.addObjectList(columnInfo.contentsColKey, contentsManagedCopy);
        } else {
            builder.addObjectList(columnInfo.contentsColKey, new RealmList<ilimboxAndroid.bphc.ilimbox.models.course.Content>());
        }
        builder.addInteger(columnInfo.courseSectionIdColKey, realmObjectSource.realmGet$courseSectionId());
        builder.addBoolean(columnInfo.isUnreadColKey, realmObjectSource.realmGet$isUnread());
        builder.addString(columnInfo.nameColKey, realmObjectSource.realmGet$name());
