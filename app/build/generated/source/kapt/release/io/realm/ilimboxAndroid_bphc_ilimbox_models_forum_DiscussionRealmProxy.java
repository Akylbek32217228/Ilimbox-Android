...
public class ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxy extends ilimboxAndroid.bphc.ilimbox.models.forum.Discussion
    implements RealmObjectProxy, ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface {
    ...
    private ProxyState<ilimboxAndroid.bphc.ilimbox.models.forum.Discussion> proxyState;
    private RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment> attachmentsRealmList;

    ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<ilimboxAndroid.bphc.ilimbox.models.forum.Discussion>(this);
    ...
    @Override
    public RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment> realmGet$attachments() {
        proxyState.getRealm$realm().checkIfValid();
        ...
        if (attachmentsRealmList != null) {
            ...
            attachmentsRealmList = new RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment>(ilimboxAndroid.bphc.ilimbox.models.forum.Attachment.class, osList, proxyState.getRealm$realm());
            return attachmentsRealmList;
        }
    }

    @Override
    public void realmSet$attachments(RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment> value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment> original = value;
                value = new RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment>();
                for (ilimboxAndroid.bphc.ilimbox.models.forum.Attachment item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ilimboxAndroid.bphc.ilimbox.models.forum.Attachment linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static ilimboxAndroid.bphc.ilimbox.models.forum.Discussion createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        ilimboxAndroid.bphc.ilimbox.models.forum.Discussion obj = null;
        if (update) {
            Table table = realm.getTable(ilimboxAndroid.bphc.ilimbox.models.forum.Discussion.class);
            DiscussionColumnInfo columnInfo = (DiscussionColumnInfo) realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.forum.Discussion.class);
            ...
            if (colKey != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(colKey), realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.forum.Discussion.class), false, Collections.<String> emptyList());
                    obj = new io.realm.ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxy) realm.createObjectInternal(ilimboxAndroid.bphc.ilimbox.models.forum.Discussion.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxy) realm.createObjectInternal(ilimboxAndroid.bphc.ilimbox.models.forum.Discussion.class, json.getInt("id"), true, excludeFields);
                }
            } else {
        ...
        final ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface objProxy = (ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) obj;
        ...
        if (json.has("attachments")) {
            if (json.isNull("attachments")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ilimboxAndroid.bphc.ilimbox.models.forum.Attachment item = ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static ilimboxAndroid.bphc.ilimbox.models.forum.Discussion createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final ilimboxAndroid.bphc.ilimbox.models.forum.Discussion obj = new ilimboxAndroid.bphc.ilimbox.models.forum.Discussion();
        final ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface objProxy = (ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$attachments(new RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        ilimboxAndroid.bphc.ilimbox.models.forum.Attachment item = ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$attachments().add(item);
                    }
                    reader.endArray();
                }
    ...
    private static ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.forum.Discussion.class), false, Collections.<String>emptyList());
        io.realm.ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxy obj = new io.realm.ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static ilimboxAndroid.bphc.ilimbox.models.forum.Discussion copyOrUpdate(Realm realm, DiscussionColumnInfo columnInfo, ilimboxAndroid.bphc.ilimbox.models.forum.Discussion object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (ilimboxAndroid.bphc.ilimbox.models.forum.Discussion) cachedRealmObject;
        }

        ilimboxAndroid.bphc.ilimbox.models.forum.Discussion realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(ilimboxAndroid.bphc.ilimbox.models.forum.Discussion.class);
            long pkColumnKey = columnInfo.idColKey;
            long colKey = table.findFirstLong(pkColumnKey, ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$id());
            if (colKey == Table.NO_MATCH) {
                canUpdate = false;
            } else {
                try {
                    objectContext.set(realm, table.getUncheckedRow(colKey), columnInfo, false, Collections.<String> emptyList());
                    realmObject = new io.realm.ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxy();
    ...
    public static ilimboxAndroid.bphc.ilimbox.models.forum.Discussion copy(Realm realm, DiscussionColumnInfo columnInfo, ilimboxAndroid.bphc.ilimbox.models.forum.Discussion newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (ilimboxAndroid.bphc.ilimbox.models.forum.Discussion) cachedRealmObject;
        }

        ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface realmObjectSource = (ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) newObject;
        ...
        io.realm.ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        // Finally add all fields that reference other Realm Objects, either directly or through a list
        RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment> attachmentsList = realmObjectSource.realmGet$attachments();
        if (attachmentsList != null) {
            RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment> attachmentsRealmList = realmObjectCopy.realmGet$attachments();
            attachmentsRealmList.clear();
            for (int i = 0; i < attachmentsList.size(); i++) {
                ilimboxAndroid.bphc.ilimbox.models.forum.Attachment attachmentsItem = attachmentsList.get(i);
                ilimboxAndroid.bphc.ilimbox.models.forum.Attachment cacheattachments = (ilimboxAndroid.bphc.ilimbox.models.forum.Attachment) cache.get(attachmentsItem);
                if (cacheattachments != null) {
                    attachmentsRealmList.add(cacheattachments);
                } else {
                    attachmentsRealmList.add(ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy.copyOrUpdate(realm, (ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy.AttachmentColumnInfo) realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.forum.Attachment.class), attachmentsItem, update, cache, flags));
                }
            }
        }
    ...
    public static long insert(Realm realm, ilimboxAndroid.bphc.ilimbox.models.forum.Discussion object, Map<RealmModel,Long> cache) {
        ...
        long pkColumnKey = columnInfo.idColKey;
        long colKey = Table.NO_MATCH;
        Object primaryKeyValue = ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$id();
        if (primaryKeyValue != null) {
            colKey = Table.nativeFindFirstInt(tableNativePtr, pkColumnKey, ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$id());
        }
        if (colKey == Table.NO_MATCH) {
            colKey = OsObject.createRowWithPrimaryKey(table, pkColumnKey, ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$id());
        } else {
            Table.throwDuplicatePrimaryKeyException(primaryKeyValue);
        }
        cache.put(object, colKey);
        Table.nativeSetLong(tableNativePtr, columnInfo.discussionIdColKey, colKey, ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$discussionId(), false);
        String realmGet$name = ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.nameColKey, colKey, realmGet$name, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.timeModifiedColKey, colKey, ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$timeModified(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.parentColKey, colKey, ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$parent(), false);

        RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment> attachmentsList = ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$attachments();
        if (attachmentsList != null) {
            OsList attachmentsOsList = new OsList(table.getUncheckedRow(colKey), columnInfo.attachmentsColKey);
            for (ilimboxAndroid.bphc.ilimbox.models.forum.Attachment attachmentsItem : attachmentsList) {
                Long cacheItemIndexattachments = cache.get(attachmentsItem);
                if (cacheItemIndexattachments == null) {
                    cacheItemIndexattachments = ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy.insert(realm, attachmentsItem, cache);
                }
                attachmentsOsList.addRow(cacheItemIndexattachments);
            }
        }
        String realmGet$userFullName = ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$userFullName();
        ...
        String realmGet$userPictureUrl = ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$userPictureUrl();
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isPinnedColKey, colKey, ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$isPinned(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.forumIdColKey, colKey, ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$forumId(), false);
        String realmGet$subject = ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$subject();
        if (realmGet$subject != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.subjectColKey, colKey, realmGet$subject, false);
        }
        String realmGet$message = ((ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) object).realmGet$message();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        DiscussionColumnInfo columnInfo = (DiscussionColumnInfo) realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.forum.Discussion.class);
        long pkColumnKey = columnInfo.idColKey;
        ilimboxAndroid.bphc.ilimbox.models.forum.Discussion object = null;
        while (objects.hasNext()) {
            object = (ilimboxAndroid.bphc.ilimbox.models.forum.Discussion) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, ilimboxAndroid.bphc.ilimbox.models.forum.Discussion object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(ilimboxAndroid.bphc.ilimbox.models.forum.Discussion.class);
        ...
        if (attachmentsList != null && attachmentsList.size() == attachmentsOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexattachments = cache.get(attachmentsItem);
                if (cacheItemIndexattachments == null) {
                    cacheItemIndexattachments = ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy.insertOrUpdate(realm, attachmentsItem, cache);
                }
    ...
    public static ilimboxAndroid.bphc.ilimbox.models.forum.Discussion createDetachedCopy(ilimboxAndroid.bphc.ilimbox.models.forum.Discussion realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        ilimboxAndroid.bphc.ilimbox.models.forum.Discussion unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new ilimboxAndroid.bphc.ilimbox.models.forum.Discussion();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (ilimboxAndroid.bphc.ilimbox.models.forum.Discussion) cachedObject.object;
            }
            unmanagedObject = (ilimboxAndroid.bphc.ilimbox.models.forum.Discussion) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface unmanagedCopy = (ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) unmanagedObject;
        ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface realmSource = (ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) realmObject;
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment> managedattachmentsList = realmSource.realmGet$attachments();
            RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment> unmanagedattachmentsList = new RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment>();
            unmanagedCopy.realmSet$attachments(unmanagedattachmentsList);
            int nextDepth = currentDepth + 1;
            int size = managedattachmentsList.size();
            for (int i = 0; i < size; i++) {
                ilimboxAndroid.bphc.ilimbox.models.forum.Attachment item = ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy.createDetachedCopy(managedattachmentsList.get(i), nextDepth, maxDepth, cache);
    ...
    static ilimboxAndroid.bphc.ilimbox.models.forum.Discussion update(Realm realm, DiscussionColumnInfo columnInfo, ilimboxAndroid.bphc.ilimbox.models.forum.Discussion realmObject, ilimboxAndroid.bphc.ilimbox.models.forum.Discussion newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface realmObjectTarget = (ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) realmObject;
        ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface realmObjectSource = (ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxyInterface) newObject;
        Table table = realm.getTable(ilimboxAndroid.bphc.ilimbox.models.forum.Discussion.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, flags);
        builder.addInteger(columnInfo.idColKey, realmObjectSource.realmGet$id());
        ...
        RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment> attachmentsList = realmObjectSource.realmGet$attachments();
        if (attachmentsList != null) {
            RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment> attachmentsManagedCopy = new RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment>();
            for (int i = 0; i < attachmentsList.size(); i++) {
                ilimboxAndroid.bphc.ilimbox.models.forum.Attachment attachmentsItem = attachmentsList.get(i);
                ilimboxAndroid.bphc.ilimbox.models.forum.Attachment cacheattachments = (ilimboxAndroid.bphc.ilimbox.models.forum.Attachment) cache.get(attachmentsItem);
                if (cacheattachments != null) {
                    ...
                    attachmentsManagedCopy.add(ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy.copyOrUpdate(realm, (ilimboxAndroid_bphc_ilimbox_models_forum_AttachmentRealmProxy.AttachmentColumnInfo) realm.getSchema().getColumnInfo(ilimboxAndroid.bphc.ilimbox.models.forum.Attachment.class), attachmentsItem, true, cache, flags));
                }
            }
            builder.addObjectList(columnInfo.attachmentsColKey, attachmentsManagedCopy);
        } else {
            builder.addObjectList(columnInfo.attachmentsColKey, new RealmList<ilimboxAndroid.bphc.ilimbox.models.forum.Attachment>());
        }
        builder.addString(columnInfo.userFullNameColKey, realmObjectSource.realmGet$userFullName());
        builder.addString(columnInfo.userPictureUrlColKey, realmObjectSource.realmGet$userPictureUrl());
        builder.addBoolean(columnInfo.isPinnedColKey, realmObjectSource.realmGet$isPinned());
    ...
    public boolean equals(Object o) {
        ...
        ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxy aDiscussion = (ilimboxAndroid_bphc_ilimbox_models_forum_DiscussionRealmProxy)o;
