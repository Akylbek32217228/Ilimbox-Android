...
public final class ActivityBrowserBinding implements ViewBinding {
  ...
  private ActivityBrowserBinding(@NonNull ConstraintLayout rootView,
      @NonNull ProgressBar browserProgress, @NonNull AdvancedWebView webView) {
  ...
  public static ActivityBrowserBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.browser_progress;
      ProgressBar browserProgress = rootView.findViewById(id);
      if (browserProgress == null) {
        break missingId;
      }

      id = R.id.web_view;
      AdvancedWebView webView = rootView.findViewById(id);
      if (webView == null) {
        break missingId;
      }

      return new ActivityBrowserBinding((ConstraintLayout) rootView, browserProgress, webView);
    }
